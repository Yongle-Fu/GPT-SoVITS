...
print(f"torch.cuda.is_available():{torch.cuda.is_available()}，version: {torch.__version__}，cuda: {torch.version.cuda}")
...
with gr.Blocks(title="GPT-SoVITS WebUI") as app:
    ...
    with gr.Tabs():
        with gr.TabItem(i18n("0-前置数据集获取工具")):#提前随机切片防止uvr5爆内存->uvr5->slicer->asr->打标
            ...
            with gr.Row():
                with gr.Row():
                    slice_inp_path=gr.Textbox(label=i18n("音频自动切分输入路径，可文件可文件夹"),value="output/denoise_opt")
            ...
            with gr.Row():
                ...
                denoise_input_dir=gr.Textbox(label=i18n("降噪音频文件输入文件夹"),value="audios/src")
            ...
            with gr.Row():
                ...
                path_list = gr.Textbox(
                    ...
                    value="C:\\Users\\Administrator\\Desktop\\GPT-SoVITS\\output\\asr_opt\\slicer_opt.list",
                    interactive=True,
                )
        ...
        with gr.TabItem(i18n("1-GPT-SoVITS-TTS")):
            ...
            with gr.TabItem(i18n("1A-训练集格式化工具")):
                ...
                with gr.Row():
                    inp_text = gr.Textbox(label=i18n("*文本标注文件"),value="C:\\Users\\Administrator\\Desktop\\GPT-SoVITS\\output\\asr_opt\\slicer_opt.list",interactive=True)
